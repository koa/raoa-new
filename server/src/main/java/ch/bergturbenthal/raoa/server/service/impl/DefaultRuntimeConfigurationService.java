...
public class DefaultRuntimeConfigurationService implements RuntimeConfigurationService {
  ...
  public DefaultRuntimeConfigurationService(
      final RaoaProperties properties, final ObjectMapper objectMapper) {
    ...
    writer =
        objectMapper
            .writerFor(GlobalConfigurationData.class)
            .with(SerializationFeature.INDENT_OUTPUT);
  }

  @Override
  public synchronized void editGlobalConfiguration(
      final Function<GlobalConfigurationData, GlobalConfigurationData> configEditor) {
