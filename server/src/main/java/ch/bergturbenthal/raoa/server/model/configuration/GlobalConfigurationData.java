...
public class GlobalConfigurationData {
  @NonNull private Map<String, UserData> knownUsers;

  public static Function<GlobalConfigurationData, GlobalConfigurationData> editUser(
      final String email, final Function<UserData, UserData> userEditor) {
    return c -> {
