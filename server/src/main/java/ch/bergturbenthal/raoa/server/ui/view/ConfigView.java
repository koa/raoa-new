...
public class ConfigView extends CustomComponent implements View {
  public ConfigView(final RaoaProperties configuration) {
    ...
    binder
        .forField(configBaseField)
        .bind(source -> source.getConfigurationBase().getAbsolutePath(), null);
    ...
    binder
        .forField(storageBaseField)
        .bind(source -> source.getStorageBase().getAbsolutePath(), null);
