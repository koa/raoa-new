...
@Slf4j
@GRpcService
public class UploadTestService extends RequestFileUploadServiceGrpc.RequestFileUploadServiceImplBase {
    ...
    @Override
    public void requestFileUpload(final FileUploadRequest request, final StreamObserver<FileUploadResponse> responseObserver) {
        ...
        final FileUploadResponse response = FileUploadResponse.newBuilder().setUploadHandle(upload.getHandle()).build();
